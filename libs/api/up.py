...
class UpService(Service):
    ...
    def get_api_info():
        api_info = {
            ...
            'DownloadKey':
                ApiInfo(
                    'POST', '/up', {'Action': 'DownloadKey', 'Version': '2022-01-01'}, {}, {}),
            'Download':
                ApiInfo(
    ...
    def UploadRaw(self, params: up_types.UploadRawRequest, file: BinaryIO) -> up_types.UploadRawResponse:
        """ 不分片的上传接口
        ...
        resp = self.session.post(url, headers=r.headers, data=file,
    ...
    def LongLive(self, params: up_types.LongLiveRequest) -> up_types.LongLiveResponse:
        ...
        """
        return up_types.LongLiveResponse.model_validate(self.__request('LongLive', params.model_dump()))

    def DownloadKey(self, params: up_types.DownloadKeyRequest) -> up_types.DownloadKeyResponse:
        """ 将某个文件转换成长效存储的文件。
